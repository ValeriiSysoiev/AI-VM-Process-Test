(() => {
    ...
    const openCriticalVulns = document.getElementById("openCriticalVulns");
    const complianceDashboard = document.getElementById("complianceDashboard");
    const recentSlaBreaches = document.getElementById("recentSlaBreaches");
   ...
   setStoredData('context', 'employee');
        ...
        if (viewIframe) {
            ...
            switch (viewRoute) {
                ...
                case 'task':
                    ...
                    break;
                case 'critical':
                    viewIframe.src = 'home/critical.html' + noCache;
                    break;
                case 'compliance':
                    viewIframe.src = 'home/compliance.html' + noCache;
                    break;
                case 'sla':
                    viewIframe.src = 'home/sla.html' + noCache;
                    break;
                default:
    ...
    const homeActions = () => {
        ...
        if (openCriticalVulns) {
            openCriticalVulns.addEventListener('click', (event) => {
                event.preventDefault();
                setQueryParam('v', 'critical');
                switchView();
            });
        }

        if (complianceDashboard) {
            complianceDashboard.addEventListener('click', (event) => {
                event.preventDefault();
                setQueryParam('v', 'compliance');
                switchView();
            });
        }

        if (recentSlaBreaches) {
            recentSlaBreaches.addEventListener('click', (event) => {
                event.preventDefault();
                setQueryParam('v', 'sla');
                switchView();
            });
